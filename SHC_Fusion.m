% average/max fusion rule

%{
mask = load_untouch_nii('765864_mask.nii');     %%%%%%%%%%%%%%%%%%
brain_mask = mask.img;
...
nii_3T = load_untouch_nii('765864_3T_new.nii');   %%%%%%%%%%%%%%%%%%
nii_3T_b0 = nii_3T.img(:,:,:,index_3T_b0);

load S765864_SHC_7T_b1000.mat;                    %%%%%%%%%%%%%%%%%%
load S765864_SHC_7T_b2000.mat;                    %%%%%%%%%%%%%%%%%%
load 765864_SHC_3T_b1000.mat;                     %%%%%%%%%%%%%%%%%%
load 765864_SHC_3T_b2000.mat                      %%%%%%%%%%%%%%%%%%
...
% test
% Fusion_3T_7T_b1000 = SHC_7T_b1000;
% Fusion_3T_7T_b2000 = SHC_7T_b2000;
...
save_untouch_nii(nii_3T, 'Fusion_3T_7T_inversed_ave.nii');   
%}
...
for iii = 2:26
    ...
    bval_3T_b0_b1000_b2000 = bval_3T([index_3T_b0 index_3T_b1000 index_3T_b2000]);
    bvec_3T_b0_b1000_b2000 = bvec_3T(:,[index_3T_b0 index_3T_b1000 index_3T_b2000]);
    save([Subjects{iii} '_bval_3T_b0_b1000_b2000_ave.bval'],'bval_3T_b0_b1000_b2000','-ascii');
    save([Subjects{iii} '_bvec_3T_b0_b1000_b2000_ave.bvec'],'bvec_3T_b0_b1000_b2000','-ascii');    
...
%     Fusion_3T_7T_b2000 = max(SHC_3T_b2000,SHC_7T_b2000);
    ...
    nii_3T.hdr.dime.dim = [4,200,200,132,N_gradient,1,1,1];
    nii_3T.img = Fusion_3T_7T_inversed;
    save_untouch_nii(nii_3T, [Subjects{iii} '_Fusion_3T_7T_inversed_ave.nii']);   
end
...
nii_3T.hdr.dime.dim = [4,200,200,132,N_gradient,1,1,1];
nii_3T.img = Fusion_3T_7T_inversed;
save_untouch_nii(nii_3T, 'Fusion_3T_7T_inversed_max.nii');   
%}
